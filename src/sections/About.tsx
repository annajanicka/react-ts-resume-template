      ...
      <Section id="about" title="About Me">
            ...
            <Row>
              <Col md={12}>
                <div className="text-center mb-3">
                  <img src={about.avatar} alt="anna janicka" style={{ width: '150px', borderRadius: '50%' }} />
                </div>
              </Col>
              <Col md={12}>
              ...
              <Row>
                <Col md={8}>
                  ...
                  <div className="mt-3 mb-3">
                    <a href="https://github.com/annajanicka" className="btn btn-kd" target="_blank" rel="noopener noreferrer">View on Github</a>
                  </div>
                </Col>
                <Col md={4}>
        ...
        <Row className="mt-5">
          {about.statistics.map(statistic => (
            <Counter
              key={statistic.title}
              className={`col-md-${(12 / about.statistics.length).toString()} col-sm-12`}
